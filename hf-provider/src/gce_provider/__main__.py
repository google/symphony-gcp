...
from gce_provider.db.reconcile import main as reconcile_db
...
valid_commands = ValidCommands(
    {
        ...
        "reconcileDB": lambda config, payload: cmd_reconcile_db(config, payload),
...
def cmd_reconcile_db(_: Config, __:Optional[dict] = None) -> Optional[BaseModel]:
